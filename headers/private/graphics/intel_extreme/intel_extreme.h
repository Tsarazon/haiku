...
// Register Base Addresses (MCH/ICH Platforms)
...
// Register Base Addresses (PCH Platforms)
...
// Legacy Backlight (Gen2, i915GM, i945GM)

#define LEGACY_BACKLIGHT_BRIGHTNESS		0xf4


// Graphics Page Translation Table (GTT)
...
#define DISPLAY_MONITOR_PORT_DETECTED	(1UL << 2)
...
#define LVDS_POST2_RATE_SLOW			14
...
// DisplayPort Link M/N Registers
...
// IronLake PCH Reference Clock Control
...
#define PCH_SOUTH_BLC_PWM_CONTROL		(0x8250 | REGS_SOUTH_SHARED)
...
#define FDI_RX_CTL(pipe) \
		(_FDI_RXA_CTL + (_FDI_RXB_CTL - _FDI_RXA_CTL) * (pipe - INTEL_PIPE_A))
#define _FDI_RXA_MISC					0xf0010
#define _FDI_RXB_MISC					0xf1010
#define FDI_RX_MISC(pipe) \
		(_FDI_RXA_MISC + (_FDI_RXB_MISC - _FDI_RXA_MISC) * (pipe - INTEL_PIPE_A))
#define _FDI_RXA_IIR					0xf0014
#define _FDI_RXB_IIR					0xf1014
#define FDI_RX_IIR(pipe) \
		(_FDI_RXA_IIR + (_FDI_RXB_IIR - _FDI_RXA_IIR) * (pipe - INTEL_PIPE_A))
#define _FDI_RXA_IMR					0xf0018
#define _FDI_RXB_IMR					0xf1018
#define FDI_RX_IMR(pipe) \
		(_FDI_RXA_IMR + (_FDI_RXB_IMR - _FDI_RXA_IMR) * (pipe - INTEL_PIPE_A))
...
#define FDI_RX_TUSIZE1(pipe) \
		(_FDI_RXA_TUSIZE1 + (_FDI_RXB_TUSIZE1 - _FDI_RXA_TUSIZE1) * (pipe - INTEL_PIPE_A))
#define FDI_RX_TUSIZE2(pipe) \
		(_FDI_RXA_TUSIZE2 + (_FDI_RXB_TUSIZE2 - _FDI_RXA_TUSIZE2) * (pipe - INTEL_PIPE_A))
...
#define FDI_TX_CTL(pipe) \
		(_FDI_TXA_CTL + (_FDI_TXB_CTL - _FDI_TXA_CTL) * (pipe - INTEL_PIPE_A))
...
// Overlay Structures and Definitions
