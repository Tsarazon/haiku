...
enum {
	...
	// Modern device support for AR/VR, voice assistants, and AI (Haiku Phase 5.1)
	// Voice and AI Assistant Controls (0x2F0+)
	B_HID_UID_CON_VOICE_ASSISTANT = 0x2F0,
	B_HID_UID_CON_AI_ASSISTANT,
	B_HID_UID_CON_AI_CONTEXT_MENU,
	B_HID_UID_CON_AI_DICTATION,
	B_HID_UID_CON_AI_TRANSLATION,

	// Gesture and Spatial Input Controls
	B_HID_UID_CON_GESTURE_CONTROL,
	B_HID_UID_CON_HAND_GESTURE_UP,
	B_HID_UID_CON_HAND_GESTURE_DOWN,
	B_HID_UID_CON_HAND_GESTURE_LEFT,
	B_HID_UID_CON_HAND_GESTURE_RIGHT,
	B_HID_UID_CON_HAND_GESTURE_GRAB,
	B_HID_UID_CON_HAND_GESTURE_PINCH,
	B_HID_UID_CON_HAND_GESTURE_SWIPE,

	// Touch Bar and Dynamic Function Row Support (0x300+)
	B_HID_UID_CON_DYNAMIC_FUNCTION_ROW = 0x300,
	B_HID_UID_CON_DYNAMIC_KEY_1,
	B_HID_UID_CON_DYNAMIC_KEY_2,
	B_HID_UID_CON_DYNAMIC_KEY_3,
	B_HID_UID_CON_DYNAMIC_KEY_4,
	B_HID_UID_CON_DYNAMIC_KEY_5,
	B_HID_UID_CON_DYNAMIC_KEY_6,
	B_HID_UID_CON_DYNAMIC_KEY_7,
	B_HID_UID_CON_DYNAMIC_KEY_8,
	B_HID_UID_CON_TOUCH_BAR_SCRUBBER,
	B_HID_UID_CON_TOUCH_BAR_SLIDER,
	B_HID_UID_CON_CONTEXT_MENU_BUTTON,
	B_HID_UID_CON_EMOJI_PICKER_BUTTON,
	B_HID_UID_CON_DICTATION_BUTTON,
	B_HID_UID_CON_SPOTLIGHT_SEARCH,

	// Gaming and Streaming Controls (0x310+)
	B_HID_UID_CON_GAME_CAPTURE = 0x310,
	B_HID_UID_CON_STREAM_START_STOP,
	B_HID_UID_CON_STREAM_PAUSE,
	B_HID_UID_CON_STREAM_MUTE_UNMUTE,
	B_HID_UID_CON_GAME_MODE_TOGGLE,
	B_HID_UID_CON_PERFORMANCE_OVERLAY,
	B_HID_UID_CON_REPLAY_BUFFER_SAVE,
	B_HID_UID_CON_INSTANT_REPLAY,

	// Advanced Input Devices (VR/AR/XR)
	B_HID_UID_CON_6DOF_CONTROLLER,
	B_HID_UID_CON_HAND_TRACKING,
	B_HID_UID_CON_EYE_TRACKING,
	B_HID_UID_CON_HEAD_TRACKING,
	B_HID_UID_CON_BODY_TRACKING,

	// Haptic and Force Feedback
	B_HID_UID_CON_HAPTIC_FEEDBACK,
	B_HID_UID_CON_HAPTIC_INTENSITY,
	B_HID_UID_CON_FORCE_FEEDBACK_ENABLE,

	// Spatial Audio for AR/VR
	B_HID_UID_CON_SPATIAL_AUDIO,
	B_HID_UID_CON_SPATIAL_AUDIO_MODE,
	B_HID_UID_CON_HEAD_RELATED_AUDIO,

	// AR/VR Immersion Controls
	B_HID_UID_CON_AR_OVERLAY,
	B_HID_UID_CON_AR_PLACEMENT_MODE,
	B_HID_UID_CON_VR_IMMERSION,
	B_HID_UID_CON_VR_ENVIRONMENT_SELECT,
	B_HID_UID_CON_MIXED_REALITY_MODE,

	// Accessibility Controls
	B_HID_UID_CON_ACCESSIBILITY_MENU,
	B_HID_UID_CON_VOICE_CONTROL_ENABLE,
	B_HID_UID_CON_SCREEN_READER_TOGGLE,
	B_HID_UID_CON_HIGH_CONTRAST_TOGGLE,
	B_HID_UID_CON_MAGNIFIER_TOGGLE
};
