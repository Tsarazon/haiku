 ...
 *
 * ARM64 EFI Platform Header
 */
#ifndef EFI_ARM64_PLATFORM_H
#define EFI_ARM64_PLATFORM_H
...
// Character definitions for ARM64 EFI console
...
// Scan code definitions for ARM64 EFI keyboard
