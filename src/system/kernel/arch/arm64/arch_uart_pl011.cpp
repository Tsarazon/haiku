 ...
 *
 * ARM PrimeCell PL011 UART Driver for ARM64
 * 
 * This driver provides support for the ARM PrimeCell PL011 UART,
 * commonly found in ARM64 systems including Raspberry Pi 5 (BCM2712).
 *
 * Authors:
...
// FIFO Level Select Register Bits
	...
	DebugUART(base, clock)
{
	...
	// Write a 0 to the port and wait for confirm..
	Out32(PL01x_DR, 0);
...
ArchUARTPL011::InitEarly()
{
	...
	// For ARM64, ensure proper memory mapping is set up
}
