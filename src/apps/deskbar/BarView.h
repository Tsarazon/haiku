...
// Taskbar mode constants (horizontal bottom expando)
const float kTaskbarHeight      = 40.0f;
const float kStartButtonWidth   = 72.0f;
...
TaskbarAccentColor()
{
	// Use the system highlight color so taskbar respects user themes.
	// Falls back to a reasonable blue on default installs.
