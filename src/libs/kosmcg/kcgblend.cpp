// kcgblend.cpp — Core blend/composite rendering engine
// C++20
...
// Delegates to sample_gradient_argb() (kcgprivate.hpp) for spread / interpolation,
...
// bilerp_argb is defined in kcgutils.hpp
