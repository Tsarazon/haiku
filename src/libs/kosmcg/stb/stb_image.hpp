// kosmcg::stbi - Image loader/writer library
...
//
//   auto img = kosmcg::stbi::load("photo.jpg");
//   if (img) { /* use img.data(), img.width(), etc. */ }
//
//   kosmcg::stbi::write_png("out.png", img);
//   kosmcg::stbi::write_jpg("out.jpg", img, {.jpeg_quality = 90});
